...
public class Paso2 extends javax.swing.JFrame {
    ...
    public Paso2() {
        ...
        L3.setIcon(img1);
        ImageIcon imagen2 = new ImageIcon(getClass().getResource("/resources/imagenes/2.png"));
        ...
        L5.setIcon(imgs);
        ImageIcon im1 = new ImageIcon(getClass().getResource("/desafio/proceso/Componente2.1.png"));
        Icon imgi = new ImageIcon(im1.getImage().getScaledInstance(i1.getWidth(), i1.getHeight(), Image.SCALE_SMOOTH));
        i1.setIcon(imgi);
        ImageIcon im2 = new ImageIcon(getClass().getResource("/desafio/proceso/Componente2.2.png"));
        Icon imgi2 = new ImageIcon(im2.getImage().getScaledInstance(i2.getWidth(), i2.getHeight(), Image.SCALE_SMOOTH));
        i2.setIcon(imgi2);
         ImageIcon im3 = new ImageIcon(getClass().getResource("/desafio/proceso/Componente2.3.png"));
    ...
    private void initComponents() {
        ...
        getContentPane().add(L2, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 20, 100, 100));
        ...
        i1.setText("jLabel1");
        getContentPane().add(i1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 20, 375, 250));

        i2.setText("jLabel1");
        getContentPane().add(i2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 300, 350, 275));

        i3.setText("jLabel1");
        getContentPane().add(i3, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 300, 350, 275));
