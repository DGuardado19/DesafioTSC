...
public class Paso5 extends javax.swing.JFrame {
    ...
    public Paso5() {
        ...
        L5.setIcon(imgs);
        ImageIcon im1 = new ImageIcon(getClass().getResource("/desafio/proceso/Componente5.1.png"));
        Icon imgi = new ImageIcon(im1.getImage().getScaledInstance(i1.getWidth(), i1.getHeight(), Image.SCALE_SMOOTH));
        i1.setIcon(imgi);
        ImageIcon im2 = new ImageIcon(getClass().getResource("/desafio/proceso/Componente5.2.png"));
    ...
    private void initComponents() {
        ...
        getContentPane().add(L2, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 30, 100, 100));
        ...
        i1.setText("jLabel1");
        getContentPane().add(i1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 220, 400, 350));

        i2.setText("jLabel1");
        getContentPane().add(i2, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 300, 375, 200));
