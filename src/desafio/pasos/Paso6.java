...
public class Paso6 extends javax.swing.JFrame {
    ...
    public Paso6() {
        ...
        L3.setIcon(img1);
        ImageIcon imagen2 = new ImageIcon(getClass().getResource("/resources/imagenes/6.png"));
        ...
        L5.setIcon(imgs);
        ImageIcon im1 = new ImageIcon(getClass().getResource("/desafio/proceso/Componente6.1.png"));
        Icon imgi = new ImageIcon(im1.getImage().getScaledInstance(i1.getWidth(), i1.getHeight(), Image.SCALE_SMOOTH));
        i1.setIcon(imgi);
        ImageIcon im2 = new ImageIcon(getClass().getResource("/desafio/proceso/Componente6.2.png"));
    ...
    private void initComponents() {
        ...
        getContentPane().add(L5, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 30, 100, 100));

        i1.setText("jLabel1");
        getContentPane().add(i1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 230, 400, 275));

        i2.setText("jLabel2");
        getContentPane().add(i2, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 230, 400, 275));
