...
public class Paso1 extends javax.swing.JFrame {
    ...
    public Paso1() {
        ...
        L3.setIcon(img1);
        ImageIcon imagen2 = new ImageIcon(getClass().getResource("/resources/imagenes/1.png"));
        ...
        L5.setIcon(imgs);
        ImageIcon im1 = new ImageIcon(getClass().getResource("/desafio/proceso/Componente1.1.png"));
        Icon imgi = new ImageIcon(im1.getImage().getScaledInstance(i1.getWidth(), i1.getHeight(), Image.SCALE_SMOOTH));
        i1.setIcon(imgi);
        ImageIcon im2 = new ImageIcon(getClass().getResource("/desafio/proceso/Componente1.2.png"));
    ...
    private void initComponents() {
        ...
        i1.setText("jLabel1");
        getContentPane().add(i1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 230, 400, 250));

        i2.setText("jLabel1");
        getContentPane().add(i2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 180, 450, 400));
