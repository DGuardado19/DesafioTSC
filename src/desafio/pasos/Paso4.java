...
public class Paso4 extends javax.swing.JFrame {
    ...
    public Paso4() {
        ...
        L3.setIcon(img1);
        ImageIcon imagen2 = new ImageIcon(getClass().getResource("/resources/imagenes/4.png"));
        ...
        L5.setIcon(imgs);
        ImageIcon im1 = new ImageIcon(getClass().getResource("/desafio/proceso/Componente4.1.png"));
        Icon imgi = new ImageIcon(im1.getImage().getScaledInstance(i1.getWidth(), i1.getHeight(), Image.SCALE_SMOOTH));
        i1.setIcon(imgi);
        ImageIcon im2 = new ImageIcon(getClass().getResource("/desafio/proceso/Componente4.2.png"));
        Icon imgi2 = new ImageIcon(im2.getImage().getScaledInstance(i2.getWidth(), i2.getHeight(), Image.SCALE_SMOOTH));
        i2.setIcon(imgi2);
        ImageIcon im3 = new ImageIcon(getClass().getResource("/desafio/proceso/Componente4.3.png"));
        Icon imgi3 = new ImageIcon(im3.getImage().getScaledInstance(i3.getWidth(), i3.getHeight(), Image.SCALE_SMOOTH));
        i3.setIcon(imgi3);
    ...
    private void initComponents() {
        ...
        getContentPane().add(L1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 20, 100, 100));
        ...
        getContentPane().add(L2, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 20, 100, 100));
        ...
        getContentPane().add(L5, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 20, 100, 100));

        i1.setText("jLabel1");
        getContentPane().add(i1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 10, 350, 225));

        i2.setText("jLabel1");
        getContentPane().add(i2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 280, 350, 300));

        i3.setText("jLabel1");
        getContentPane().add(i3, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 270, 350, 300));
