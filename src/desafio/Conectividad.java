 ...
 * @author David
 */
public class Conectividad extends javax.swing.JFrame {
    ...
    public Conectividad() {
        ...
        L1.setIcon(imgb);
        ImageIcon imagen = new ImageIcon(getClass().getResource("/resources/fondos/FondoCon.png"));
    ...
    private void initComponents() {
        ...
        L2.setText("jLabel2");
        getContentPane().add(L2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 850, 510));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conectividad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Conectividad().setVisible(true);
            }
        });
    }
